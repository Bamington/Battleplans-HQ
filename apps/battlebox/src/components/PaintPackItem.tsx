/**
 * PaintPackItem.tsx — One paint pack in the browse sheet: brand thumbnail,
 * name, an "N paints" badge, an optional Official pill and description, and an
 * Add / Remove action. Modeled on BattleCards' PackListItem, in BattleBox's
 * design language.
 */
...
export function PaintPackItem({ pack, busy, onAdd, onRemove }: {
  pack: PaintPack;
  busy: boolean;
  onAdd?: () => void;
  onRemove?: () => void;
