...
const UserPlusRounded = ({ className }: Props) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
...
<path d="M17 16.6665V19.3332" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
export default UserPlusRounded;
